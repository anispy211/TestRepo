...
//     [UIFont fontWithName:@"DIN-Medium" size:21],
//     NSFontAttributeName, [UIColor whiteColor],NSFontAttributeName,nil] ;
}
...
- (void)setAssetsGroup:(ALAssetsGroup *)assetsGroup
{
    ...
    // Set title
     NSString * str = [self.assetsGroup valueForProperty:ALAssetsGroupPropertyName];
