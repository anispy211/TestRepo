...
//
//  Created by Tanaka Katsuma on 2016/01/01.
//  Copyright (c) 2016年 Katsuma Tanaka. All rights reserved.
//
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        QBAssetsCollectionCheckmarkView *checkmarkView = [[QBAssetsCollectionCheckmarkView alloc] initWithFrame:CGRectMake(self.bounds.size.width - (4.0 + 24.0), 4, 24.0, 24.0)];
