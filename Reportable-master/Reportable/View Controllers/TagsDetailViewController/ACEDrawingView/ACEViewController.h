...
@interface ACEViewController : UIViewController<CAAnimationDelegate>
...
@property (nonatomic, unsafe_unretained) IBOutlet UIBarButtonItem *clearButton;
@property (nonatomic, unsafe_unretained) IBOutlet UIBarButtonItem *shareButton;


@property (nonatomic, unsafe_unretained) IBOutlet UIButton *tempBtn;
